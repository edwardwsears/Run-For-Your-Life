...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        System.out.println("Created SQLiteDatabase");
        System.out.println(CREATE_USERINFO_TABLE);
    }
    ...
    public void addUser (User user) {
        ...
        ContentValues values = new ContentValues();
        values.put(KEY_USERNAME, user.getName());
        values.put(KEY_PASSWORD, user.getPw(1));
        values.put(KEY_HEALTH , user.getHealth(2));
        values.put(KEY_AMMO , user.getAmmo(3));
        values.put(KEY_LEVEL, user.getLevel(4));
        values.put(KEY_FRIENDS , user.getFriends(5));
    ...
    public User getUser (int id) {
        ...
        Cursor cursor = db.query(TABLE_USERINFO, new String[] {KEY_ID}, KEY_ID + "=?", 
                new String[] {""+id}, null, null, null, null);
        System.out.println(cursor.toString());
        System.out.println(cursor.getString(0));
        String username = cursor.getString(0);
        String password = cursor.getString(1);
        int[] info = {Integer.parseInt(cursor.getString(2)),
                        Integer.parseInt(cursor.getString(3)), 
                        Integer.parseInt(cursor.getString(4))};
        String friends = cursor.getString(5);
        
        User user = new user(username, password,info,friends);
    ...
    public int updateUser (User user) {
        ...
        // updating row
        return db.update(TABLE_USERINFO, values, KEY_ID + " = ?", new String[] { String.valueOf(user.getName()) });
    }
    
    public void deleteUser (String user) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TABLE_USERINFO, KEY_ID + " = ?", new String[] { user });
